...
class PDF(FPDF):
    def __init__(self):
        super().__init__()
        # Türkçe karakter desteği için Unicode font ekle
        # fpdf2'de varsayılan olarak Unicode desteği var, ama emin olmak için
    ...
    def _safe_text(self, text):
        ...
        if text is None:
            return ""
        # String ise direkt döndür (fpdf2 Unicode destekliyor)
        return str(text)
    ...
    def add_invoice(self, data):
        ...
        self.cell(0, 20, self._safe_text(data["title"]), ln=True, align="C")
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        try:
            ...
            # PDF'i bytes olarak al (fpdf2'de output(dest='S') zaten bytes döndürüyor)
